...
std::string InstructionToString(const Instruction& inst) {
	...
	switch (inst.op) {
		...
		case Opcode::IMadI64I32: text += "IMadI64I32"; break;
		case Opcode::DivScaleF32: text += "DivScaleF32"; break;
		case Opcode::DivScaleF64: text += "DivScaleF64"; break;
		...
		case Opcode::AtomicIncU32: text += "AtomicIncU32"; break;
		case Opcode::AtomicDecU32: text += "AtomicDecU32"; break;
		case Opcode::AtomicFMinF32: text += "AtomicFMinF32"; break;
		case Opcode::AtomicFMaxF32: text += "AtomicFMaxF32"; break;
		case Opcode::AtomicFcmpswapF32: text += "AtomicFcmpswapF32"; break;
		...
		case Opcode::ImageLoadPck: text += "ImageLoadPck"; break;
		case Opcode::ImageLoadPckSgn: text += "ImageLoadPckSgn"; break;
		case Opcode::ImageLoadMipPck: text += "ImageLoadMipPck"; break;
		case Opcode::ImageLoadMipPckSgn: text += "ImageLoadMipPckSgn"; break;
		case Opcode::ImageMsaaLoad: text += "ImageMsaaLoad"; break;
		case Opcode::ImageBvhIntersectRay: text += "ImageBvhIntersectRay"; break;
		case Opcode::ImageBvh64IntersectRay: text += "ImageBvh64IntersectRay"; break;
		case Opcode::ImageStore: text += "ImageStore"; break;
		case Opcode::ImageStorePck: text += "ImageStorePck"; break;
		case Opcode::ImageStoreMipPck: text += "ImageStoreMipPck"; break;
